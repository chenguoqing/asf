...
/**
 * Any persist exception should be wrapped with {@link StatePersistException}.
 */
public class StatePersistException extends StateMachineException {
    /**
     * Constructs a new exception with {@code null} as its detail message.
     * The cause is not initialized, and may subsequently be initialized by a
     * call to {@link #initCause}.
     */
    public StatePersistException() {
        super();
    }
